|     | Issue | Instances |
| --- | --- | --- |
| NC-01| Using a floating pragma `^0.8.13` statement is discouraged |4|
| NC-02 | Use of bytes.concat() instead of abi.encodePacked() | 6  |

## [NC-01]Using a floating pragma `^0.8.13` statement is discouraged as code can compile to different bytecodes with different compiler versions. Use a stable pragma statement to get a deterministic bytecode.
