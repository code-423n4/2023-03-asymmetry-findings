...
[G0-1] ++i is more gas efficient than i++ in loops forwarding .
...
[G0-2] x += y/x -= y costs more gas than x = x + y/x = x - y for state variables.
...
[G0-3] Use custom errors rather than revert()/require() strings to save gas. 
...
[G0-4] Avoid using state variable in emit 

https://github.com/code-423n4/2023-03-asymmetry/blob/44b5cd94ebedc187a08884a7f685e950e987261c/contracts/SafEth/SafEth.sol#L214-L244

Using a state variable in emits wastes gas.