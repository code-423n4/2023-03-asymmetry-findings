...
## [NC-1] Important events are missing
There are 7 instance of it
its good to implement events for these certain actions to track them
...
There are 6 instances of them
its good to clear them for better readablity of the code and makes it clear
...
## [NC-4] Use a more recent solidity version
Context:All contracts
