...
could directly use totalWeight variable,setting that to 0 at before the loop start and increase it in the cycle,without creating a local temp variable(localTotalWeight)
