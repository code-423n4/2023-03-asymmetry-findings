possible unchecked {} calculations to save gas in
...
could directly use totalWeight variable,setting that to 0 before the loop start and increase it in the cycle,without creating a local temp variable(localTotalWeight)
...
directly set the variable to it's opposite (!variable) without the need of a param
